...
public class OrderItemRepository {
    ...
    public List<Integer> getUsers(int oid) {
        ...
        List<OrderItemModel> orders = jdbcTemplate.query(
            sql,
            new BeanPropertyRowMapper<>(OrderItemModel.class),
            oid
        );
    ...
    public List<OrderItemModel> getHostViewOrderItems(int oid) {
        String sql =
            "SELECT uof.uid, uof.foodName, uof.hostViewFoodName, uof.hostViewPrice, uof.num, uof.comment " +
