...
public class RestaurantController {
    ...
    public ResponseEntity<String> getRestaurants(
        ...
        if (uid == -1) return ResponseEntity
        ...
        return ResponseEntity.status(code).body(formatStr);
    }
    ...
    public ResponseEntity<String> deleteRestaurantDetail(
        ...
        if (success == 0) return ResponseEntity
            .status(HttpStatus.OK)
            .body(
                "{\"message\": \"Please refrain from deleting information about others' restaurants\"}"
            );
        ...
        return ResponseEntity
            ...
            .body(
                String.format(
                    "{\"message\":\" The %s Restaurant has been deleted.\"}",
                    rid
                )
            );
    }
    ...
    public ResponseEntity<String> putRestaurantDetail(
        ...
        if (images != null && updateCounts != 0) {
            ...
            message =
                "Update the restaurant or images successfully: " + fileNames;
        } else {
            if (updateCounts == 0) message =
                "Fail to update restaurant or image, because the restaurant is deleted or didn't exist! "; else message =
                "Update the restaurant successfully";
        }
        return ResponseEntity
            .status(code)
